        ...
        <div class="card card-success card-outline">
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    &nbsp;
                    Clustering Mata Pelajaran
                </h3>
                <div class="card-tools">
                    <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal-lg"><i
                            class="fa fa-sync"></i>&nbsp;Kelola Clustering</button>

                    <div class="modal fade" id="modal-lg">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Kelola Data Clustering</h4>
                                    ...
                                    <div class="row" style="width: 100%; text-align: center">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" style="width: 100%" class="btn btn-primary btn-tambah"
                                                data-dismiss="modal"><i class="fa fa-sync"></i>&nbsp;Kelola Cluster</button>
                                        </div>
                                    </div>
...
@endsection
@section('js')
<script type="module" src="{{ asset('js/clustering/app.js') }}"></script>
@endsection